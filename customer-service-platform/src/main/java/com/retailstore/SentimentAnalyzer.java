...
public class SentimentAnalyzer {
    ...
    /**
     * Constructor initializes the Stanford CoreNLP pipeline with necessary
     * properties.
     */
    ...
    /**
     * Processes the feedback file and returns a list of feedback entries with
     * sentiment analysis
     *
    ...
    public List<FeedbackEntry> processFeedbackFile(String filePath) throws IOException {
        ...
        System.out.println("Found " + (rawEntries.length - 1) + " potential feedback entries."); // -1 because first
    ...
    private FeedbackEntry parseEntry(String entryText) {
        ...
        try {
            ...
            for (String line : lines) {
                ...
                // Note: We're ignoring the original sentiment line as we'll calculate it
                // ourselves
            }
